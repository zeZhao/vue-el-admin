...
export const constantRoutes = [
  ...
  },
  {
    path: '/',
    component: Layout,
    redirect: '/billingData',
    // children: [
    //   {
    //     path: '/billingData',
    //     name: 'billingData',
    //     component: () => import(/* webpackChunkName: "about" */  '@/views/billingData/index.vue'),
    //     meta: {
    //       title: '账单数据'
    //     }
    //   },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: '/taskManagement',
        name: 'taskManagement',
        component: () => import(/* webpackChunkName: "about" */  '@/views/billingData/taskManagement.vue'),
        meta: {
          title: '任务管理'
        }
      },
