    ...
    >
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column label="发送方" prop="type"></el-table-column>
          <el-table-column label="发送类型" prop="operator"></el-table-column>
          <el-table-column label="发送日期" prop="num"></el-table-column>
          <el-table-column label="发送数量（条）" prop="num"></el-table-column>
        ...
        >
          <el-table-column label="合计" prop="name"></el-table-column>
          <el-table-column label="发送方" prop="type"></el-table-column>
          <el-table-column label="发送类型" prop="operator"></el-table-column>
        ...
        <el-table border :data="tableData1" style="margin-top: 24px">
          <el-table-column
            label="提交时间"
            prop="name"
            width="187"
      ...
      <div class="table">
        ...
        >
          <el-table-column label="序号" prop="name"></el-table-column>
          <el-table-column label="发送方" prop="type">
            <template>
              <span>新华</span>
            </template>
          </el-table-column>
