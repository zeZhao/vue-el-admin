<template>
  <div class="dataExport">
    ...
    >
      ...
      <div class="table">
        <p class="table_title">短信平台技术服务对账单</p>
        <p class="table_auther">至【国美信科技投资有限公司】：</p>
        <p class="table_time" v-if="ruleForm.time[0]">
          对账周期：{{ ruleForm.time[0] }}至{{ ruleForm.time[1] }}
        </p>
        <p class="table_time" v-else>
          对账周期：【】年【】月【】日至【】年【】月【】日
        </p>
        <el-table
          border
        ...
        >
          <el-table-column label="付款公司" prop="name"></el-table-column>
          <el-table-column label="产品类型" prop="type"></el-table-column>
          <el-table-column label="运营商类型" prop="operator"></el-table-column>
          <el-table-column label="结算单价/元" prop="num"></el-table-column>
          <el-table-column label="发送条数" prop="num"></el-table-column>
          <el-table-column label="发送成功条数" prop="num"></el-table-column>
          <el-table-column label="计费条数" prop="num"></el-table-column>
          <el-table-column label="结算金额/元" prop="num"></el-table-column>
        </el-table>
        ...
        <div class="table_company clearfix">
          <div class="company_left">
            ...
            <p>开户银行：兴业银行北京经济技术开发区支行</p>
            <p>账号：321130100100479678</p>
          </div>
